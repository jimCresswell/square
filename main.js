...
world.createCSSRules = function () {
	var cssRules = document.styleSheets[0],
		terrainResource, terrainClass,
		featureResource, featureClass,
		rule;
...
/*
document.addEventListener('keydown', interface.MoveOnKeyMatch, true);
document.addEventListener('keyup', interface.startListeningOnKeyMatch, true);
*/
document.addEventListener('keyup', interface.MoveOnKeyMatch, true);
